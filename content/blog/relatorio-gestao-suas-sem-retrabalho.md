---
title: "Relatório de gestão do SUAS sem retrabalho de fim de mês"
description: "Como estruturar o relatório de gestão apresentado ao CMAS e à Câmara Municipal a partir de dados já registrados no dia a dia, sem reconstruir números de última hora."
date: "2026-06-17"
...
Há ainda um problema de consistência: se o relatório de gestão é montado de um jeito e o [RMA foi enviado ao governo federal](/blog/como-preencher-rma-sem-retrabalho) de outro, os números não batem entre si. Isso gera questionamento do CMAS, da Câmara ou, em casos mais sérios, de órgão de controle — porque a mesma rede socioassistencial, no mesmo período, está sendo descrita de duas formas diferentes em dois documentos oficiais.
...
**3. Acompanhar indicador ao longo do ano, não só no fechamento.** Um coordenador que consulta mensalmente [indicadores de cobertura, fluxo e vigilância socioassistencial](/blog/indicadores-cras-alem-do-rma) chega ao momento do relatório de gestão com a maior parte do trabalho já feito — porque estava acompanhando o dado o tempo todo, não descobrindo tudo de uma vez em dezembro.

## Relatório de gestão e PMAS: uma via de mão dupla

O relatório de gestão presta contas do que foi feito; o [PMAS](/blog/pmas-dados-dia-a-dia) define o que se pretende fazer. Os dois documentos deveriam se retroalimentar: o relatório mostra se as metas do plano foram atingidas, e essa informação entra no próximo PMAS (ou na sua revisão) como diagnóstico atualizado.
