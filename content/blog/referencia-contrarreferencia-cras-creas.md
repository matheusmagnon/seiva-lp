---
title: "Referência e contrarreferência entre CRAS e CREAS"
description: "O que significam referência e contrarreferência no SUAS e como estruturar o fluxo entre CRAS e CREAS sem perder o histórico do caso encaminhado."
date: "2026-06-03"
...
Fazer a diferenciação entre a situação que ainda cabe ao CRAS e a que já exige o CREAS é justamente o tema do texto sobre [PAEFI e sua diferença em relação ao PAIF](/blog/paefi-o-que-e-diferenca-paif). A referência formal é o mecanismo que opera essa transição.
...
Esse último ponto tem relação direta com o cuidado exigido pela escuta protegida, especialmente quando o caso envolve criança ou adolescente vítima de violência — reencaminhar sem histórico aumenta o risco de revitimização por repetição de relato, tema tratado no texto sobre [escuta especializada e protegida](/blog/escuta-especializada-protegida-registro).
...
1. **Formulário padronizado de encaminhamento**, com identificação da família, motivo do encaminhamento, resumo do acompanhamento já realizado e ponto de contato responsável em cada unidade.
2. **Confirmação de recebimento** por parte da unidade que recebe o caso, com prazo definido para retorno.
3. **Registro do encaminhamento no prontuário da família**, de forma que qualquer técnico autorizado, em qualquer das duas unidades, veja que o caso está em trânsito e para onde.
4. **Formalização da contrarreferência** como etapa obrigatória do encerramento do PAEFI, não como algo que acontece "se der tempo".
