---
title: "Busca ativa no território: estruturar sem perder o registro"
description: "Como estruturar a busca ativa no território de abrangência do CRAS e evitar que o trabalho de campo se perca por falta de registro sistemático."
date: "2026-06-02"
...
1. **Diagnóstico do território.** Antes de sair a campo, a equipe usa dados já disponíveis — CadÚnico, indicadores de vigilância socioassistencial, informações de outras políticas (saúde, educação) — para identificar áreas prioritárias. Esse cruzamento de fonte de dado é aprofundado no texto sobre [diagnóstico socioterritorial](/blog/diagnostico-socioterritorial-dados).
...
5. **Encaminhamento.** Conforme o que foi identificado, a família é encaminhada para inclusão no CadÚnico, para acompanhamento do PAIF, ou, em situação de violação de direitos, para o CREAS via fluxo de [referência e contrarreferência](/blog/referencia-contrarreferencia-cras-creas).
...
- **A família identificada na busca ativa nunca aparece no RMA**, porque o registro de campo e o [registro mensal de atendimentos](/blog/como-preencher-rma-sem-retrabalho) são feitos em sistemas — ou planilhas — diferentes, sem integração.
...
Esse último ponto é especialmente relevante para a [vigilância socioassistencial](/blog/vigilancia-socioassistencial-na-pratica): a busca ativa só vira dado de gestão quando o registro de campo é estruturado desde o início, não reconstruído a posteriori.
