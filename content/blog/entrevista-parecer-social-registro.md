---
title: "Entrevista e parecer social: registro sem retrabalho"
description: "Como estruturar o registro da entrevista social e do parecer social no SUAS para que a informação alimente o prontuário uma única vez, sem retrabalho para o técnico."
date: "2026-06-11"
...
A entrevista pode acontecer em diferentes momentos do trabalho: na acolhida inicial, num atendimento particularizado, numa visita domiciliar, ou como parte da elaboração de um [Plano de Acompanhamento Familiar](/blog/plano-acompanhamento-familiar-sem-duplicar). O conteúdo muda conforme o momento, mas a lógica é a mesma: escuta qualificada, registro do que foi dito e observado, e uso dessa informação para decidir o próximo passo.
...
O princípio é simples: a entrevista deveria ser registrada uma vez, diretamente ligada ao [prontuário da família](/blog/prontuario-suas-o-que-e), e o parecer deveria ser escrito a partir desse registro — não a partir de anotações paralelas.
