---
title: "Equipe de referência (NOB-RH) e organização da agenda"
description: "O que a NOB-RH/SUAS define sobre a equipe de referência do CRAS e como essa composição se traduz na organização prática da agenda de atendimentos."
date: "2026-06-10"
...
Quando cada profissional mantém sua própria agenda isolada — numa agenda de papel, numa planilha pessoal ou de memória —, o coordenador não tem visão do todo. O resultado mais comum é o [duplo agendamento](/blog/agenda-atendimentos-cras-duplo-agendamento): duas famílias marcadas no mesmo horário, ou uma visita domiciliar agendada para um dia em que o único veículo disponível já está reservado para outra equipe.
...
Esse é também o ponto em que a implementação da [NOB-SUAS de forma geral](/blog/nob-suas-na-pratica) se conecta à gestão de pessoas: uma equipe de referência bem dimensionada, mas sem agenda coordenada, não entrega o resultado que a norma pressupõe.
